package uk.soulwire.utils.display 
{
	...
	{	
		...
		public static function fitIntoRect(displayObject : DisplayObject, rectangle : Rectangle, fillRect : Boolean = true, align : String = "C", applyTransform : Boolean = true) : Matrix
		{
			...
			switch(align)
			{
				case DisplayUtilsAlignment.LEFT :
				case DisplayUtilsAlignment.TOP_LEFT :
				case DisplayUtilsAlignment.BOTTOM_LEFT :
					tX = 0.0;
					break;
					
				case DisplayUtilsAlignment.RIGHT :
				case DisplayUtilsAlignment.TOP_RIGHT :
				case DisplayUtilsAlignment.BOTTOM_RIGHT :
					tX = w - wR;
					break;
			...
			switch(align)
			{
				case DisplayUtilsAlignment.TOP :
				case DisplayUtilsAlignment.TOP_LEFT :
				case DisplayUtilsAlignment.TOP_RIGHT :
					tY = 0.0;
					break;
					
				case DisplayUtilsAlignment.BOTTOM :
				case DisplayUtilsAlignment.BOTTOM_LEFT :
				case DisplayUtilsAlignment.BOTTOM_RIGHT :
					tY = h - hR;
					break;
			...
			if(applyTransform)
			{
				...
				if(displayObject.scaleX == Infinity)
				{
